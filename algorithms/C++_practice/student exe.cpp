...
int main()
{
	Student a("AA", "AA", "1111", "604-123-1234", 3.4);
	Student b("BB", "BB", "2222", "604-223-2234", 2.6);
	Student c("CC", "CC", "3333", "604-333-3234", 3.8);
	Student d("DD", "DD", "4444", "604-423-4234", 2.1);
	Student e("EE", "EE", "5555", "778-123-5234", 2.8);
	Student f("FF", "FF", "6666", "778-456-6234", 3.3);
	Course table("CMPT1020", 1, 35);
	table.add(a);
	table.add(b);
	table.add(c);
	table.add(d);
